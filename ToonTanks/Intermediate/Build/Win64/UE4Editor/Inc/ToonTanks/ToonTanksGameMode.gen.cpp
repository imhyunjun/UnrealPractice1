...
#include "ToonTanks/Pawn/ToonTanksGameMode.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	void AToonTanksGameMode::GameOver(bool _wonGame)
	{
		ToonTanksGameMode_eventGameOver_Parms Parms;
		Parms._wonGame=_wonGame ? true : false;
	...
	{
		static void NewProp__wonGame_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp__wonGame;
	...
	void Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::NewProp__wonGame_SetBit(void* Obj)
	{
		((ToonTanksGameMode_eventGameOver_Parms*)Obj)->_wonGame = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::NewProp__wonGame = { "_wonGame", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ToonTanksGameMode_eventGameOver_Parms), &Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::NewProp__wonGame_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::NewProp__wonGame,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AToonTanksGameMode_GameOver_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Pawn/ToonTanksGameMode.h" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AToonTanksGameMode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AToonTanksGameMode_GameOver, "GameOver" }, // 208498831
		{ &Z_Construct_UFunction_AToonTanksGameMode_StartGame, "StartGame" }, // 192583344
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AToonTanksGameMode_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "Pawn/ToonTanksGameMode.h" },
		{ "ModuleRelativePath", "Pawn/ToonTanksGameMode.h" },
	...
	IMPLEMENT_CLASS(AToonTanksGameMode, 2719685193);
